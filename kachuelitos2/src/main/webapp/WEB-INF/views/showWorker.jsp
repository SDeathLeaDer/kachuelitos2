		...
		<div id='contentSearh'>
			<div id='cv'>
				<div id='headercv'>
					...
					<div id='photocv'>
						<div id='photo' align="center">FOTO</div>
					</div>
					<div id='personalcv'>
						<b style="size: 3px;">Datos Personales</b> <br> <br> <b>DNI:</b>
						${userworker. dniuser}<br> <b>Nombre y Apellidos:</b>
						${userworker.nombreUser} ${userworker.apellidoUser}<br> <b>Correo:</b>
						${userworker.correoUser}<br> <b>Telefono:</b>
						${userworker.telefonoUser}<br> <b> Dirección:</b>
						${userworker.direccionUser}<br>
				...
				<div id='aboutcv'>
					<b>Acerca de mi :</b> <br> <br>${worker.resumenTrabajador}</div>
				<div id='experiencecv'>
					<b>Experiencia:</b> <br> <br>${worker.experienciaTrabajador}</div>
